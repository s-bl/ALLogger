...
def main():
    ...
    start = 0
    if os.path.exists('/tmp/allogger/dummy/checkpoint.npy'):
        start, step_per_key = np.load('/tmp/allogger/dummy/checkpoint.npy', allow_pickle=True)
    ...
    logger.log(np.random.rand(1, 1500, 1500), 'blub')
